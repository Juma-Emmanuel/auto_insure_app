...
class MedicalClaimsHistory extends StatefulWidget {
  const MedicalClaimsHistory({super.key});

  @override
  State<MedicalClaimsHistory> createState() => _MedicalClaimsHistoryState();
}

class _MedicalClaimsHistoryState extends State<MedicalClaimsHistory> {
                    ...
                    showMenu(
                      ...
                      items: [
                        PopupMenuItem(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, '/medicalclaimdetailsreport');
                          },
                        ),
                        PopupMenuItem(
                          child: Row(
